...
// Codul sursă pentru Vertex Shader
...
// Codul sursă pentru Fragment Shader
...
int main()
{
    ...
    // Ștergerea shaderelor care nu mai sunt necesare
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Calcularea matricei de model
        glm::mat4 model = glm::mat4(1.0f); // matrice de identitate
